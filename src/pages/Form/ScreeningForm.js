  ...
  function recordData(userId, user_data) {
    ...
    axios
      .post(
        api_url +
          api_route +
          "record?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiUGF0dGFudW4gTnVtcG9uZyIsInBhc3N3b3JkIjoic3NyZzgzNCJ9.g-r1MSNdircjhOC98wcaJ1sFg5zaMSupVLW4h68rgnc",
        {
          user_id: userId,
          user_data: user_data,
        }
